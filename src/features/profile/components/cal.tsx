...
export function ScheduleCallPopup({
    ...
    return (
        <Button
            ...
            className={cn(
                "shadow-none hover:bg-background hover:text-primary border-[0.3px] border-transparent hover:border-b-4 hover:border-primary/30 active:border-b transition-all",
                className,
            )}
        >
