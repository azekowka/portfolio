import { GlobeIcon, GitHubLogoIcon, LinkedInLogoIcon } from "@radix-ui/react-icons";

export const hackathonsConfig = [
    {
    ...
    },
    {
        ...
        image:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNsjKANBRTfRCyjItdFS28eww1y10q3-IFfg&s",
        win: "",
        mlh: "https://s3.amazonaws.com/logged-assets/trust-badge/2017/white.svg",
        links: [
            {
